...
class TeamControllerTest extends WebTestCase
{
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            'team[name]' => 'Testing',
            'team[is_active]' => 'Testing',
            'team[created_at]' => 'Testing',
            'team[updated_at]' => 'Testing',
        ]);
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            ...
            'team[is_active]' => 'Something New',
            'team[created_at]' => 'Something New',
            'team[updated_at]' => 'Something New',
        ]);
